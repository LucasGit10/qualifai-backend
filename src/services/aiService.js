...
module.exports = {
  ...
  inferCampaignContactColumns: aiContentService.inferCampaignContactColumns.bind(aiContentService),
  analyzeNegotiationStrategy: aiContentService.analyzeNegotiationStrategy.bind(aiContentService),
